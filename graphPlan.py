...
def independentPair(a1, a2):
  ...
  def common_data(list1, list2):
    # type: (list[Proposition], list[Proposition]) -> bool
    result = False
  ...
  # check for negating effects
  if common_data(a1.getAdd(), a2.getDelete()) or common_data(a1.getDelete(), a2.getAdd()) or \
     common_data(a1.getPre(), a2.getDelete()) or common_data(a1.getDelete(), a2.getPre()):
    return False
  return True
